		...
		<div className='section__wrapper'>
			<div className='app-gallery__text'>
				...
				<p>
					...
					iste culpa eos distinctio fuga nihil facere illo impedit, quisquam
					aspernatur quasi reprehenderit ipsa architecto, molestiae.
				</p>
			...
			<div className='app-gallery__images'>
				<Swiper
					...
					<SwiperSlide>
						<Image src={images.gallery01} alt='Gallery image' />
					</SwiperSlide>
					<SwiperSlide>
						<Image src={images.gallery02} alt='Gallery image' />
					</SwiperSlide>
					<SwiperSlide>
						<Image src={images.gallery03} alt='Gallery image' />
					</SwiperSlide>
					<SwiperSlide>
						<Image src={images.gallery04} alt='Gallery image' />
					</SwiperSlide>
				</Swiper>
			</div>
		</div>
